...
|------------------------------------- |--------- |------------:|----------:|----------:|------------:|------------:|------------:|------:|--------:|-----------:|----------:|------------:|------------:|
| '0.1% — Full scan (no index)'        | 10000    |   0.9725 ms | 1.1541 ms | 0.6036 ms |   0.7322 ms |   0.6871 ms |   2.4507 ms |  1.18 |    0.79 |          - |         - |    403736 B |       1.000 |
| '0.1% — Index scan'                  | 10000    |   0.0667 ms | 0.0105 ms | 0.0069 ms |   0.0683 ms |   0.0567 ms |   0.0743 ms |  0.08 |    0.02 |          - |         - |      5032 B |       0.012 |
| '0.1% — SQLite full scan (no index)' | 10000    |   0.2088 ms | 0.0190 ms | 0.0126 ms |   0.2120 ms |   0.1844 ms |   0.2254 ms |  0.25 |    0.07 |          - |         - |       704 B |       0.002 |
| '0.1% — SQLite index scan'           | 10000    |   0.0642 ms | 0.0116 ms | 0.0077 ms |   0.0607 ms |   0.0569 ms |   0.0776 ms |  0.08 |    0.02 |          - |         - |       704 B |       0.002 |
| '20% — Full scan (no index)'         | 10000    |   1.4574 ms | 1.3997 ms | 0.9258 ms |   0.8473 ms |   0.8010 ms |   3.5141 ms |  1.77 |    1.21 |          - |         - |    403728 B |       1.000 |
| '20% — Index scan'                   | 10000    |   0.8016 ms | 0.5448 ms | 0.3242 ms |   0.8965 ms |   0.3879 ms |   1.3391 ms |  0.97 |    0.47 |          - |         - |      5024 B |       0.012 |
| '20% — SQLite full scan (no index)'  | 10000    |   0.3784 ms | 0.0507 ms | 0.0302 ms |   0.3820 ms |   0.3462 ms |   0.4365 ms |  0.46 |    0.13 |          - |         - |       704 B |       0.002 |
| '20% — SQLite index scan'            | 10000    |   0.3918 ms | 0.0609 ms | 0.0362 ms |   0.3734 ms |   0.3609 ms |   0.4589 ms |  0.48 |    0.14 |          - |         - |       704 B |       0.002 |
|                                      |          |             |           |           |             |             |             |       |         |            |           |             |             |
| '0.1% — Full scan (no index)'        | 1000000  | 144.2128 ms | 2.6935 ms | 1.7816 ms | 144.1342 ms | 141.9574 ms | 146.7913 ms | 1.000 |    0.02 | 12000.0000 | 4000.0000 | 104121640 B |       1.000 |
| '0.1% — Index scan'                  | 1000000  |   1.1870 ms | 0.0946 ms | 0.0625 ms |   1.1834 ms |   1.1031 ms |   1.3102 ms | 0.008 |    0.00 |          - |         - |    101008 B |       0.001 |
| '0.1% — SQLite full scan (no index)' | 1000000  |  19.2514 ms | 0.1467 ms | 0.0767 ms |  19.2541 ms |  19.1627 ms |  19.3697 ms | 0.134 |    0.00 |          - |         - |       704 B |       0.000 |
| '0.1% — SQLite index scan'           | 1000000  |   1.2976 ms | 0.0515 ms | 0.0269 ms |   1.2964 ms |   1.2570 ms |   1.3307 ms | 0.009 |    0.00 |          - |         - |       704 B |       0.000 |
| '20% — Full scan (no index)'         | 1000000  | 151.4196 ms | 1.8823 ms | 1.2450 ms | 151.0296 ms | 149.9612 ms | 153.6703 ms | 1.050 |    0.01 | 12000.0000 | 4000.0000 | 107391152 B |       1.031 |
| '20% — Index scan'                   | 1000000  | 130.0765 ms | 1.2216 ms | 0.8080 ms | 130.0652 ms | 128.2984 ms | 131.0637 ms | 0.902 |    0.01 |  1000.0000 |         - |  15506416 B |       0.149 |
| '20% — SQLite full scan (no index)'  | 1000000  |  33.9210 ms | 0.4632 ms | 0.2756 ms |  33.8497 ms |  33.6519 ms |  34.3930 ms | 0.235 |    0.00 |          - |         - |       704 B |       0.000 |
| '20% — SQLite index scan'            | 1000000  |  42.5400 ms | 0.1636 ms | 0.0973 ms |  42.5622 ms |  42.3814 ms |  42.6836 ms | 0.295 |    0.00 |          - |         - |       704 B |       0.000 |